...
const Hero: React.FC = () => {
  const githubRepo = () => {
    ...
    window.open("https://github.com/Oia20/AimFlare", "_blank");
  }
  return (
    <div className="relative h-screen flex justify-center bg-gradient-to-b from-gray-800 to-gray-900 overflow-hidden">
      ...
      <div className="relative text-center z-10 mt-36">
        <h1 className="text-6xl text-white font-bold drop-shadow-lg">
          Unleash Your <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Precision</span>
        </h1>
        <p className="mt-4 text-lg text-gray-100">
          Train your <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">aim</span>, improve your <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">game</span>.
        </p>
        <a 
          href="#features" 
        ...
        <div className="mt-8 bg-gray-700 border-2 border-blue-500 text-gray-200 text-sm font-semibold rounded-full px-6 py-2 w-fit m-auto">
          <p><span onClick={githubRepo} className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent hover:cursor-pointer hover:animate-pulse">100% Open-Source</span>, Browser-Based, No Download Required</p>
        </div>
      </div>
    </div>
  );
